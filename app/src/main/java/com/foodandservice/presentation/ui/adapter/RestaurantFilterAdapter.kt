...
import com.foodandservice.databinding.ItemRestaurantFilterBinding
...
class RestaurantFilterAdapter constructor(private val listener: RestaurantClickListener) :
    ...
    class ViewHolder private constructor(private val binding: ItemRestaurantFilterBinding) :
        ...
        companion object {
            fun from(parent: ViewGroup): ViewHolder {
                ...
                val binding = ItemRestaurantFilterBinding.inflate(layoutInflater, parent, false)
...
class RestaurantFilterDiffCallBack : DiffUtil.ItemCallback<Restaurant>() {
