    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            btnOnboarding.setOnClickListener {
                ...
                } else binding.vpOnboarding.currentItem += 1
            }
            ...
            vpOnboarding.registerOnPageChangeCallback(object : ViewPager2.OnPageChangeCallback() {
                override fun onPageSelected(position: Int) {
                    ...
                    if (position == onboardingItems.size - 1) binding.btnOnboarding.text =
                        getString(R.string.btn_finish)
                    else binding.btnOnboarding.text = getString(R.string.btn_next)
                }
            })
